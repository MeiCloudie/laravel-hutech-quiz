                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-small btn-success"
                                href="{{ URL::to('quizCollections/' . $value->id) }}">Show this quiz collection</a>

                            <!-- edit this quiz (uses the edit method found at GET /quizCollections/{id}/edit -->
                            <a class="btn btn-small btn-info"
                                href="{{ URL::to('quizCollections/' . $value->id . '/edit') }}">Edit this quiz
                                collection</a>
                            ...
                            <form action="{{ url('quizCollections/' . $value->id) }}" method="POST" class="pull-right">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-small btn-danger">Delete this quiz
                                    collection</button>
                            </form>
