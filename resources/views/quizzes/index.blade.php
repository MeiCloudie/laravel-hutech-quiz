    ...
    @foreach($quizzes as $key => $value)
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-small btn-success" href="{{ URL::to('quizzes/' . $value->id) }}">Show this quiz</a>

                <!-- edit this quiz (uses the edit method found at GET /quizzes/{id}/edit -->
                <a class="btn btn-small btn-info" href="{{ URL::to('quizzes/' . $value->id . '/edit') }}">Edit this quiz</a>
